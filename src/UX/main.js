	...
	SignIn_SignUp_Error_Checking: function () {
		...
		_.Event(submitButtonSignUp, 'click', function(){
			...
			for(var i = 0; i < SignUpInputs.length; i++){
				if(SignUpInputs[i].value.split() == '' || SignUpInputs[i].value.split() == 'IBRAHIM TUMWESIGYE' || SignUpInputs[i].value.split().length == 10){
			...
			// phone number.
			if (SignUpInputs[1].value.split() !== '' | SignUpInputs[2].value.split().length == 10){
		...
		_.Event(submitButtonSignIn, 'click', function(){
			...
			for(var i = 0; i < SignInInputs.length; i++){
				if(SignInInputs[i].value.slice().length == 10 || SignInInputs[i].value.slice() == ''){
