/*! Fluid-inc - Simplified.js
this is a javascript helper library which helps writing less code
making your code more readable and accesible.

Copyright (c) 2020-2021 Fluid-inc Corp. All rights reserved.

All portions of this file are the confidential and proprietary
intellectual property of Fluid-inc Corp.

Author : KATO ISA AKA-(ETHAN), Africa (Uganda-Kampala),
tell / whatsApp  :  +256 705207718.
    website: https://katoisa256.ga/
    facebook: Ethan Snowden.
*/
/** 
...
let _ = {
    ...
    */
     ...
     ** 
     ** the program will check to see * if thie parameter is a string or varaible
    ...
    */
    EventAll: function (element, EventType, Task, Type = false){ 
        ...
        return _.SelectAll(element).forEach(f => {
                f.addEventListener(EventType, Task)
            });
        }
    },
